...
const KEYWORD_RULES: Array<[RegExp, MainCategory]> = [
  ...
  [
    /\b(jacket|blazer|coat|parka|windbreaker|anorak|puffer|shacket|overshirt)\b/i,
    'Outerwear',
  ],
  ...
  [
    /\b(sneaker|trainer|oxford|derby|loafer|boot|heel|flat|sandal|slide|mule|wedge|platform|espadrille|clog|slipper)\b/i,
    'Shoes',
  ],
  ...
  [
    /\b(cap|beanie|fedora|headband|sun\s*hat|bucket\s*hat|visor|beret)\b/i,
    'Headwear',
  ],

  [
    /\b(sports?\s*bra|athletic|gym|running\s*short|performance|track\s*pant)\b/i,
    'Activewear',
  ],

  [
    /\b(bra|panties|briefs|boxers?|undershirt|shapewear|thong)\b/i,
    'Undergarments',
  ],
  ...
  [
    /\b(bikini|swimsuit|swim\s*trunk|rash\s*guard|cover-?up|one-?piece)\b/i,
    'Swimwear',
  ],
