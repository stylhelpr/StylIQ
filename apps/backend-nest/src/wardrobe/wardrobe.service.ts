...
//     };
//   }
//   normalizePatternScale(pattern_scale: string): any {
...
//   // Add these inside WardrobeService (class body)

//   // 1) main_category → DTO union
//   private normalizeMainCategory(
//     val?: string | null,
//   ): CreateWardrobeItemDto['main_category'] {
//     const unions: CreateWardrobeItemDto['main_category'][] = [
...
//   // 2) pattern_scale → DTO union ('Micro' | 'Medium' | 'Bold')
//   private normalizePatternScaleDto(
//     val?: string | null,
//   ): CreateWardrobeItemDto['pattern_scale'] | undefined {
//     const s = (val ?? '').toString().trim().toLowerCase();
...
//   // 3) seasonality → DTO union ('Spring' | 'Summer' | 'Fall' | 'Winter' | 'AllSeason')
//   private normalizeSeasonalityDto(
//     val?: string | null,
//   ): CreateWardrobeItemDto['seasonality'] | undefined {
//     const s = (val ?? '').toString().trim().toLowerCase();
...
//   // 4) layering → DTO union ('Base' | 'Mid' | 'Outer')
//   private normalizeLayeringDto(
//     val?: string | null,
//   ): CreateWardrobeItemDto['layering'] | undefined {
//     const s = (val ?? '').toString().trim().toLowerCase();
...
//       ai_key_attributes: draft?.ai_key_attributes,
//       ai_confidence:
//         typeof draft?.ai_confidence === 'number'
//           ? draft.ai_confidence
//           : undefined,
