...
export class VertexService {
  ...
  // -------------------
  // Upload processed (transparent) image to GCS
  // -------------------
  ...
  async removeBackground(
    ...
    try {
      const apiKey = secretExists('PHOTOROOM_API_KEY')
        ...
        : null;
      if (!apiKey) {
        console.error('[GarmentSegmentation] PHOTOROOM_API_KEY missing');
        return null;
      }
