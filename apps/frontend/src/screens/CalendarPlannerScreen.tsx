...
//       height: 5,
//       borderRadius: 3,
//       backgroundColor: colors.inputText1 ?? theme.colors.surface3,
//       marginBottom: 8,
//     },
//     sheetHeaderRow: {
//       flexDirection: 'row',
...
//       paddingVertical: 8,
//       borderRadius: 18,
//       backgroundColor: theme.colors.surface3 ?? theme.colors.muted,
//     },
//     closePillText: {
...
//     },
//     emptyText: {color: theme.colors.foreground2, fontSize: 15},
...
//     () =>
//       scheduledOutfits.reduce((acc, outfit) => {
...
//         {/* ───── Apple-style bottom sheet modal (no logic changes) ───── */}
//         <Modal
...
//                       {selectedDate ? `Outfits • ${selectedDate}` : 'Outfits'}
//                     </Text>
//                     <AppleTouchFeedback
//                       onPress={closeModal}
...
//                           No outfits scheduled.
//                         </Text>
//                       </View>
//                     ) : (
//                       (selectedDate ? outfitsByDate[selectedDate] : [])?.map(
//                         (o, index) => (
//                           <View key={o.id ?? index} style={styles.card}>
...
//       height: 5,
//       borderRadius: 3,
//       backgroundColor: colors.inputText1 ?? 'rgba(121,121,121,0.5)',
//       marginBottom: 8,
//     },
//     sheetHeaderRow: {
//       flexDirection: 'row',
...
//       paddingVertical: 8,
//       borderRadius: 18,
//       backgroundColor: colors.input2 ?? 'rgba(43,43,43,1)',
//     },
//     closePillText: {color: colors.foreground3 ?? '#EAEAEA', fontWeight: '700'},
//     emptyState: {
//       paddingVertical: 24,
//       alignItems: 'center',
//       justifyContent: 'center',
//     },
//     emptyText: {color: colors.foreground2, fontSize: 15},
//     list: {paddingTop: 4},
//     card: {
//       borderRadius: 16,
//       padding: 14,
//       marginBottom: 12,
//       backgroundColor: colors.cardBackground ?? '#141414',
//       borderWidth: StyleSheet.hairlineWidth,
//       borderColor: colors.input2 ?? 'rgba(43,43,43,1)',
//     },
//     name: {color: colors.foreground, fontSize: 16, fontWeight: '600'},
//     time: {color: colors.foreground2, marginTop: 4, fontSize: 13},
//     row: {flexDirection: 'row', marginTop: 10},
//     thumb: {
//       width: 68,
//       height: 68,
