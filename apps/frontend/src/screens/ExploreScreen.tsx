...
// import {getWeatherForTrip} from '../utils/travelWeather';
...
// function extractDestinationFromInput(input: string): string {
//   // Basic placeholder logic — improve with NLP later
...
//   const extractDestinationFromInput = (input: string): string | null => {
//     const match = input.match(/(?:to|in|at)\s([A-Z][a-z\s]+)/i);
//     return match?.[1]?.trim() || null;
//   };

//   const submitPromptWithWeather = async () => {
//     try {
//       setLoading(true);

//       const destination = extractDestinationFromInput(query || '');
//       const weather = await getWeatherForTrip(destination || 'New York');

//       const weatherSummary = `
// Current location: ${
//         weather.weatherNow.celsius.weather[0].description
//       }, ${Math.round(weather.weatherNow.celsius.main.temp)}°C.
// Destination (${destination}): ${
//         weather.weatherDest.celsius.weather[0].description
//       }, ${Math.round(weather.weatherDest.celsius.main.temp)}°C.
//     `.trim();
...
//       // 🔧 TODO: Replace this with actual response handler
//       // setAiResponse(await callGemini(finalPrompt));
//     } catch (err) {
//       console.error('❌ Failed prompt w/ weather:', err);
//       // 🔧 setAiResponse('Could not generate AI response.');
//     } finally {
//       setLoading(false);
//     }
//   };
...
//           onPress={submitPromptWithWeather}
