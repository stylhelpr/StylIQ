...
//   useEffect(() => {
//     if (current?.missing) {
//       fetchShoppingResults(current.missing).then(setShoppingResults);
//     } else {
//       setShoppingResults([]);
//     }
//   }, [current?.missing]);
...
//   const fetchShoppingResults = async (query: string) => {
//     try {
//       const res = await fetch(
//         `${API_BASE_URL}/shopping/search?q=${encodeURIComponent(query)}`,
//       );
...
//                     ))
//                   ) : (
//                     // fallback if no products (still show Google link)
//                     <TouchableOpacity
//                       onPress={() => {
