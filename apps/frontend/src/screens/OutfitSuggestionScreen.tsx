          ...
          <View style={globalStyles.centeredSection}>
            <ScrollView
              ...
              <View
                ...
                <TextInput
                  placeholder="Refine outfit (e.g. make shorts colorful)"
                  placeholderTextColor={theme.colors.muted}
                  style={[globalStyles.promptInput, {flex: 1, marginRight: 8}]}
                  value={lastSpeech}
                  onChangeText={setLastSpeech}
                />
                <TouchableOpacity
                  style={[
                    ...
                    {width: 100, backgroundColor: '#ff8800'},
                  ]}
                  onPress={() => handleRefine(lastSpeech)}>
                  <Text style={globalStyles.buttonPrimaryText}>Refine</Text>
                </TouchableOpacity>
              </View>
