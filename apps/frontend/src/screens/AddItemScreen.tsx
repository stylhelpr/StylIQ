...
// --- input normalizers ---
const normalizePatternScale = (raw: string) => {
...
// // --- input normalizers (tiny, safe) ---
// const normalizePatternScale = (raw: string) => {
//   if (!raw) return undefined;
//   const s = raw.trim().toLowerCase();
//   // Accept numeric inputs (0/1/2)
//   if (/^-?\d+(\.\d+)?$/.test(s)) {
//     const n = Number(s);
//     if (Number.isFinite(n))
//       return n <= 0 ? 'subtle' : n === 1 ? 'medium' : 'bold';
//   }
//   // Accept word variants
//   if (['subtle', 'small', 'micro'].includes(s)) return 'subtle';
//   if (['medium', 'mid'].includes(s)) return 'medium';
//   if (['bold', 'large', 'big'].includes(s)) return 'bold';
//   return undefined;
...
//   )
//     return 'ALL_SEASON';
//   return raw; // server uppercases anyway
// };
...
//         brand,
//         pattern,
//         pattern_scale: normalizePatternScale(patternScale), // ✅ fix NaN/strings
//         seasonality: normalizeSeasonality(seasonality), // optional normalize
//         layering: normalizeLayering(layering), // optional normalize
//         tags: cleanedTags,
//       };
...
//       // (3) PINECONE SEARCH – backend returns clean id + modality
//       let inSearch = false;
//       let searchTop: Array<{id: string; score: number; modality?: string}> = [];
//       try {
//         const q =
...
//         brand,
//         pattern,
//         pattern_scale: patternScale ? Number(patternScale) : undefined,
//         seasonality,
//         layering,
//         tags: cleanedTags,
//       });
