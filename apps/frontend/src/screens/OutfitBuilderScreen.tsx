...
//     // if backend returns relative paths like /uploads/abc.jpg, prepend server origin
...
//             })} */}
//             {wardrobe.map(item => {
//               const uri = toAbsolute(item.image_url);
//               const isSelected = selectedItems.some(i => i.id === item.id);
//               return (
//                 <TouchableOpacity
//                   key={item.id}
...
//                       ]}
//                       resizeMode="cover"
//                       onLoadStart={() => console.log('🖼️ load start', uri)}
//                       onLoad={() => console.log('✅ loaded', uri)}
//                       onError={e =>
//                         console.log('❌ image error', uri, e.nativeEvent?.error)
//                       }
//                     />
//                     <Text
//                       style={{fontSize: 10, color: '#888', maxWidth: 86}}
//                       numberOfLines={1}>
//                       {uri.slice(0, 35)}
//                     </Text>
//                     {isSelected && (
