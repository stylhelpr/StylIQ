...
//         Keyboard.dismiss();
//         VoiceTarget.clear();
//         console.log('[UI] 📵 background tap — cleared voice target');
//       }}>
//       {/* ✅ single wrapper View inside */}
//       <View style={{flex: 1}}>
//         <View
//           pointerEvents="none"
...
//                     style={styles.input}
//                     onFocus={() => VoiceTarget.set(setQuery)} // ✅ listen to global mic
//                     onBlur={() => VoiceTarget.clear()} // ✅ clear when unfocused
//                   />
