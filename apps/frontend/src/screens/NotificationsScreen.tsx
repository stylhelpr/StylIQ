...
import {
  ...
  clearAll,
  AppNotification,
  subscribeInboxChange, // ✅ subscribe for real-time updates
...
export default function NotificationsScreen({
  ...
  // ✅ Subscribe to inbox changes (triggers automatically when push arrives)
  useEffect(() => {
    const unsubscribe = subscribeInboxChange(load);
    return unsubscribe;
  }, [load]);
