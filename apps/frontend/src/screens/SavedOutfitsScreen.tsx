...
//       const [aiRes, customRes] = await Promise.all([
//         fetch(`${API_BASE_URL}/outfit/suggestions/${userId}`),
//         fetch(`${API_BASE_URL}/custom-outfits/${userId}`),
//       ]);
...
//       const parsedAiData = aiData.map((outfit: any) => ({
//         ...outfit,
//         top: outfit.top
//           ? {...outfit.top, image: outfit.top.image_url}
//           : undefined,
//         bottom: outfit.bottom
//           ? {...outfit.bottom, image: outfit.bottom.image_url}
//           : undefined,
//         shoes: outfit.shoes
//           ? {...outfit.shoes, image: outfit.shoes.image_url}
//           : undefined,
//       }));

//       const parsedCustomData = customData.map((outfit: any) => ({
//         ...outfit,
//         top: outfit.top
//           ? {...outfit.top, image: outfit.top.image_url}
//           : undefined,
...
//               id: o.top.id,
//               name: o.top.name,
//               image: normalizeImageUrl(o.top.image),
//               mainCategory: '',
//               subCategory: '',
//               material: '',
//               fit: '',
...
//               id: o.bottom.id,
//               name: o.bottom.name,
//               image: normalizeImageUrl(o.bottom.image),
//               mainCategory: '',
//               subCategory: '',
//               material: '',
//               fit: '',
...
//               id: o.shoes.id,
//               name: o.shoes.name,
//               image: normalizeImageUrl(o.shoes.image),
//               mainCategory: '',
//               subCategory: '',
//               material: '',
//               fit: '',
