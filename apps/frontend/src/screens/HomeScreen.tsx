...
const HomeScreen: React.FC<Props> = ({navigate, wardrobe}) => {
  ...
  const HEADER_HEIGHT = 80; // whatever your header’s height is
        ...
        <Animated.ScrollView
          ...
          <View style={globalStyles.section}>
            <Animated.View
              ...
              {/* 🔹 Liquid Glass Overlay for Banner Text */}
              {/* <LiquidGlassView
              style={{
                position: 'absolute',
                bottom: 12,
...
// import {
//   RealLiquidGlass,
//   RealLiquidGlassElements,
// } from '../components/RealLiquidGlass/RealLiquidGlass';
