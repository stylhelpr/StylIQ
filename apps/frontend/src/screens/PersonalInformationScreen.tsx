...
//   // Only send fields that changed and are not empty
//   const handleSave = async () => {
//     try {
//       const dto: any = {};
//       if (firstName && firstName !== initialData.first_name)
...
//       navigate('Settings'); // silent success
//     } catch (err) {
//       console.error('Save failed', err); // silent error (no alerts)
//     }
//   };
...
//       {/* Profession */}
//       <Text style={[styles.label, {color: colors.foreground}]}>Profession</Text>
//       <TextInput
//         value={profession}
//         onChangeText={setProfession}
//         style={[
...
//         style={[
//           globalStyles.buttonPrimary,
//           {marginBottom: 12, backgroundColor: 'rgba(120, 120, 120, 1)'},
//         ]}>
