...
// const getLibraryPermissionName = () =>
//   Platform.OS === 'ios'
//     ? PERMISSIONS.IOS.PHOTO_LIBRARY
//     : PERMISSIONS.ANDROID.READ_EXTERNAL_STORAGE;

// export async function ensureCameraAndLibraryPermissions(): Promise<boolean> {
//   const cameraPerm = getCameraPermissionName();
//   const libraryPerm = getLibraryPermissionName();
...
//   // 2) Check photo library
//   let libStatus = await check(libraryPerm);
//   if (libStatus === RESULTS.DENIED) {
//     libStatus = await request(libraryPerm);
//   }
//   if (libStatus !== RESULTS.GRANTED) {
//     Alert.alert(
