...
//   const [washTempC, setWashTempC] = useState('');
//   const [dryClean, setDryClean] = useState('');
//   const [ironOk, setIronOk] = useState('');
//   const [sizeLabel, setSizeLabel] = useState('');
//   const [sizeSystem, setSizeSystem] = useState('');
//   const [fabricBlend, setFabricBlend] = useState('');
...
//     setPatternScale(typeof ps === 'string' ? ps : ps?.toString() ?? '');
...
//     // Extended
//     setCareSymbols(
//       Array.isArray(item.care_symbols) ? item.care_symbols.join(', ') : '',
//     );
//     setWashTempC(item.wash_temp_c?.toString() ?? '');
//     setDryClean(item.dry_clean?.toString() ?? '');
//     setIronOk(item.iron_ok?.toString() ?? '');
//     setSizeLabel(item.size_label ?? '');
//     setSizeSystem(item.size_system ?? '');
//     setFabricBlend(
//       Array.isArray(item.fabric_blend)
//         ? item.fabric_blend.map(f => `${f.percent}% ${f.fiber}`).join(', ')
//         : '',
//     );
//   }, [item]);
...
//           .map(s => s.trim())
//           .filter(Boolean),
//         wash_temp_c: washTempC ? Number(washTempC) : null,
//         dry_clean: dryClean === 'true',
//         iron_ok: ironOk === 'true',
//         size_label: sizeLabel || undefined,
//         size_system: sizeSystem || undefined,
//         fabric_blend: fabricBlend
//           ? fabricBlend.split(',').map(entry => {
//               const [percent, ...fiberParts] = entry.trim().split(/\s+/);
//               return {
//                 percent: Number(percent.replace('%', '')),
//                 fiber: fiberParts.join(' '),
//               };
//             })
//           : [],
//       };
...
//         {/* Extended */}
//         <Text style={useGlobalStyles().title}>Care Symbols</Text>
//         <TextInput
//           value={careSymbols}
//           onChangeText={setCareSymbols}
//           style={styles.input}
//           placeholder="Comma separated: MachineWashCold, DoNotBleach"
//           placeholderTextColor={theme.colors.muted}
//         />

//         <Text style={useGlobalStyles().title}>Wash Temp (°C)</Text>
//         <TextInput
//           value={washTempC}
//           onChangeText={setWashTempC}
//           style={styles.input}
//           placeholder="e.g. 30"
//           placeholderTextColor={theme.colors.muted}
...
//         <Text style={useGlobalStyles().title}>Dry Clean</Text>
//         <TextInput
//           value={dryClean}
...
//         <Text style={useGlobalStyles().title}>Iron OK</Text>
//         <TextInput
//           value={ironOk}
//           onChangeText={setIronOk}
//           style={styles.input}
//           placeholder="true / false"
//           placeholderTextColor={theme.colors.muted}
//         />

//         <Text style={useGlobalStyles().title}>Size Label</Text>
//         <TextInput
//           value={sizeLabel}
//           onChangeText={setSizeLabel}
//           style={styles.input}
//           placeholder="e.g. M, 32x32"
//           placeholderTextColor={theme.colors.muted}
//         />

//         <Text style={useGlobalStyles().title}>Size System</Text>
//         <TextInput
//           value={sizeSystem}
//           onChangeText={setSizeSystem}
//           style={styles.input}
//           placeholder="US, EU, UK, Intl"
//           placeholderTextColor={theme.colors.muted}
//         />

//         <Text style={useGlobalStyles().title}>Fabric Blend</Text>
//         <TextInput
//           value={fabricBlend}
//           onChangeText={setFabricBlend}
//           style={styles.input}
